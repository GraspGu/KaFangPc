...
//获取照片提交部分信息
if(isset($_GET['exp_part'])){
    $part = $_GET['exp_part'];
    //写入session
    $_SESSION['exp_part'] = $part;
}else{
    $url = "http://www.ka-fang.cn:8080/online/pro_data_submit.php";
    echo "<script language='javascript' type='text/javascript'>";
    echo "window.location.href='$url'";
    echo "</script>";
}
...
<div id="img_submit">
    <form action="pro_data_img_upload.php" method="post" enctype="multipart/form-data">
        <table>
            <tr>
