...
<div id="navbar">
    <ul>
        ...
        <li><a href="../online/personal_service.html"><img src="../images/导航条-在线版型设计.png"></a></li>
        <li><a href="#"><img src="../images/导航条-定制指南-量体规范.png"></a></li>
        <li><a href="#"><img src="../images/导航条-微信扫码.png"></a></li>
        <li><a href="login.php"><img src="../images/导航条-个人中心.png"></a></li>
...
<div id="version_ul">
	<form action="shopping_handle.php?order_id=<?php echo "$order_id" ?>" method="post">
	    <table>
			<tr>
			...
			<tr>
				...
				<td><a href="shopping.php">取消</a></td>
			</tr>
    	</table>
    </form>
</div>
